  ...
  return (
    <div className='relative py-4 px-6 md:px-8 bg-white'>
      <div className='flex flex-col md:flex-row items-start gap-6'>
        ...
        <div className='w-24 h-24 md:w-32 md:h-32 border-4 border-white shadow-lg absolute -top-12 md:-top-16 rounded-full overflow-hidden'>
            <img src={user.profile_picture} alt="" className='w-full h-full object-cover rounded-full block'/>
        </div>
